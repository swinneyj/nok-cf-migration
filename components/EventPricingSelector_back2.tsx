              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <input
                    ...
                    value={numGuys}
                    onChange={(e) =>
                      setNumGuys(Math.max(0, parseInt(e.target.value) || 0))
                    }
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <input
                    ...
                    value={numGirls}
                    onChange={(e) =>
                      setNumGirls(Math.max(0, parseInt(e.target.value) || 0))
                    }
                    className="w-24 rounded-md border-2 border-gray-300 bg-white px-2 py-3 text-center text-2xl font-bold text-gray-900 outline-none focus:border-purple-900"
                  />
                  <button
            ...
            {totalGuests > 0 && (
              <div className="mt-6">
                <button
                  ...
                  className="w-full rounded-lg bg-gradient-to-r from-purple-900 to-black px-6 py-3 text-lg font-semibold text-white transition hover:from-purple-800 hover:to-gray-900"
                >
                  Continue to Step 3
                </button>
              </div>
