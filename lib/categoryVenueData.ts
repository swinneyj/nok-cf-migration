...
export const poolPartyVenues: CategoryVenueCard[] = [
  ...
  { name: "Tailgate Beach Club", venue: "Mandalay Bay", desc: "Brand new Grand Opening 2026. Fresh dayclub experience with premium F&B, tiered pools, and energetic atmosphere.", img: "/images/venues/tailgate-beach-club.jpg", alt: "Tailgate Beach Club Mandalay Bay Las Vegas VIP cabana pool party", href: "/places/tailgate-beach-club", venueSlug: "tailgate-beach-club", badge: "Grand Opening" },
