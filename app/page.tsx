...
const categories = [
  {
    ...
    href: '/bachelor',
    img: '/images/venues/test-bachelor-generated.png',
    alt: 'Las Vegas bachelor party packages VIP',
  },
  {
    label: 'Bachelorette Parties',
    href: '/bachelorette',
    img: '/images/venues/test-bachelorette-generated.png',
    alt: 'Las Vegas bachelorette party packages',
  },
  {
    label: 'Nightclubs',
    href: '/nightclubs',
    img: '/images/venues/nightclubs-hero.jpg',
    alt: 'Las Vegas nightclub VIP access bottle service',
  },
  {
    label: 'Pool Parties',
    href: '/pool-parties',
    img: '/images/venues/pool-parties-hero.jpg',
    alt: 'Las Vegas pool party dayclub cabana',
  },
  {
    label: 'Party Buses',
    href: '/party-buses',
    img: '/images/venues/test-party-bus-generated.png',
    alt: 'Las Vegas party bus luxury transportation',
  },
  {
    label: 'Strip Clubs',
    href: '/strip-clubs',
    img: '/images/venues/strip-clubs-hero.jpg',
