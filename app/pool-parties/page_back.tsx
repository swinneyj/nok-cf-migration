...
const dayclubs = [
  { name: 'Encore Beach Club', venue: 'Encore at Wynn', desc: 'The gold standard of Las Vegas dayclubs. World-class DJs, private bungalows with plunge pools, Wynn service.', img: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=500&q=80', alt: 'Encore Beach Club Las Vegas VIP cabana dayclub', href: '/places/encore-beach-club', badge: '#1 Rated' },
  { name: 'Marquee Dayclub', venue: 'The Cosmopolitan', desc: 'Infinity-edge pools, rooftop bungalows with Strip views, strong hip-hop and EDM programming.', img: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=500&q=80', alt: 'Marquee Dayclub Las Vegas pool party VIP', href: '/places/marquee-dayclub', badge: 'Fan Favorite' },
  { name: 'Omnia Dayclub', venue: 'Caesars Palace', desc: 'Brand new dayclub from Hakkasan Group. Omnia-level production brought to the Las Vegas pool scene.', img: 'https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=500&q=80', alt: 'Omnia Dayclub Caesars Palace Las Vegas VIP', href: '/places/omnia-dayclub', badge: 'New' },
  { name: 'LIV Beach Club', venue: 'Fontainebleau', desc: 'The iconic Miami brand brings its poolside energy to Las Vegas. Multi-level complex, hip-hop driven.', img: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=500&q=80', alt: 'LIV Beach Club Fontainebleau Las Vegas VIP', href: '/places/liv-beach-club', badge: 'New' },
  { name: 'AYU Dayclub', venue: 'Resorts World', desc: 'Multi-pool outdoor complex with world-class DJ programming. More accessible pricing than EBC.', img: 'https://images.unsplash.com/photo-1545431781-3e1b506e9a37?w=500&q=80', alt: 'AYU Dayclub Resorts World Las Vegas VIP cabana', href: '/places/ayu-dayclub', badge: null },
  { name: 'Kassi Beach Club', venue: 'Las Vegas Strip', desc: 'Mediterranean-inspired aesthetic, deep house programming, sophisticated alternative to mega-dayclubs.', img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&q=80', alt: 'Kassi Beach Club Las Vegas pool party VIP', href: '/places/kassi-beach-club', badge: 'New' },
  { name: 'Liquid Pool Lounge', venue: 'ARIA Resort', desc: 'Adults-only boutique pool. Only 8 VIP cabanas, private dipping pools — the most exclusive dayclub in Vegas.', img: 'https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=500&q=80', alt: 'Liquid Pool Lounge ARIA Las Vegas VIP cabana', href: '/places/liquid-pool-lounge', badge: 'Adults Only' },
  { name: 'Stadium Swim', venue: 'Circa Resort', desc: "Five-story amphitheater pool with a 143-foot LED screen. Watch the game from the pool — uniquely Vegas.", img: 'https://images.unsplash.com/photo-1566417713940-fe7c737a9ef2?w=500&q=80', alt: 'Stadium Swim Circa Las Vegas pool party VIP', href: '/places/stadium-swim', badge: null },
]
    ...
    <>
      <section className="relative page-hero overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1600&q=85" alt="Las Vegas pool party dayclub VIP cabana 2026" className="w-full h-full object-cover" />
      ...
      <section className="py-20 px-4 bg-night-800/50">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12">
          ...
          <div className="card-dark p-8">
            <InquiryForm defaultPackage="pool" />
          </div>
        </div>
      </section>
    </>
