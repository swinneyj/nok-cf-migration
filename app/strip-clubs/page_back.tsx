...
const clubs = [
  { name: 'Crazy Horse 3', desc: 'Las Vegas\'s largest gentleman\'s club. World-class entertainment, multiple rooms, VIP suites.', img: 'https://images.unsplash.com/photo-1545431781-3e1b506e9a37?w=500&q=80', alt: 'Crazy Horse 3 Las Vegas VIP strip club' },
  { name: 'Sapphire', desc: '70,000 sq ft — the world\'s largest gentleman\'s club. Multiple floors and stage shows.', img: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&q=80', alt: 'Sapphire Las Vegas strip club VIP access' },
  { name: 'Spearmint Rhino', desc: 'A global brand. Las Vegas location is one of the best in the world with private VIP rooms.', img: 'https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=500&q=80', alt: 'Spearmint Rhino Las Vegas VIP' },
  { name: 'Hustler Club', desc: 'Larry Flynt\'s flagship. On the Strip, convenient, high energy, celebrity appearances.', img: 'https://images.unsplash.com/photo-1566417713940-fe7c737a9ef2?w=500&q=80', alt: 'Hustler Club Las Vegas strip club VIP' },
  { name: 'Little Darlings', desc: 'Unique all-nude venue. No alcohol allowed — drinks are BYOB or purchased inside.', img: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=500&q=80', alt: 'Little Darlings Las Vegas strip club' },
  { name: 'Palomino', desc: 'The only topless club with a full bar located directly on the Las Vegas Strip.', img: 'https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=500&q=80', alt: 'Palomino Las Vegas strip club VIP access' },
]
    ...
    <>
      <section className="relative page-hero overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=1600&q=85" alt="Las Vegas strip club VIP access packages" className="w-full h-full object-cover" />
