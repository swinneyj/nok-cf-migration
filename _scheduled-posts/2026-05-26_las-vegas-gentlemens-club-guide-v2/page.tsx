...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/blog/las-vegas-gentlemens-club-guide-v2/image.jpg' }],
  },
}
    ...
    <>
      <section className="relative pt-32 pb-16 px-4 overflow-hidden">
        <div className="absolute inset-0">
          <img src="/blog/las-vegas-gentlemens-club-guide-v2/image.jpg" alt="Las Vegas gentleman's club guide VIP access 2026" className="w-full h-full object-cover" />
